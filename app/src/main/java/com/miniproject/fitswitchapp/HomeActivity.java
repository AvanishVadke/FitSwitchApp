...
import com.miniproject.fitswitchapp.databinding.ActivityHomeBinding;
...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CardView goBMI = findViewById(R.id.bmi_calculator);
        ...
        CardView goStepCounter = findViewById(R.id.stepsCount);
        goStepCounter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(HomeActivity.this,StepCount.class));
            }
        });

        CardView goHeartRate = findViewById(R.id.heartRate);
        goHeartRate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(HomeActivity.this,HeartRate.class));
            }
        });
